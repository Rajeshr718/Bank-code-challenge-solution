...
import static com.n26.assigment.service.LangUtils.getElapsedDuration;
import static com.n26.assigment.service.LangUtils.roundDownToSeconds;
...
public class StatisticsProcessor {
	...
	private void addAmountToStats(StatisticsData statsData, double amount) {
		...
		statsData.setAvg(LangUtils.divide(statsData.getSum(), statsData.getCount()));
	...
	private void removeFromPerodicStats(long removeTimeStamp) {
		...
		if(perodicStats!=null){
			...
			draftOverallStats.setAvg(LangUtils.divide(draftOverallStats.getSum(), draftOverallStats.getCount()));
